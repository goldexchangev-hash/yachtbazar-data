/* ============================================================
   slots3d.js — "GEM VAULT 3D": a premium Vegas-style Three.js (WebGL) slot
   that renders into the TV. Faceted-gem symbol art with baked highlights, an
   ornate env-mapped GOLD cabinet, velvet backdrop + drifting bokeh, a glowing
   GEM VAULT marquee, an eased left-to-right reel stop with anticipation teases,
   glowing win rings + a coin/gem storm.
...
(function (root) {
  ...
  Slots3D.prototype._buildMarquee = function (outerH, matGold) {
    ...
    x.font = "900 150px 'Bungee',Georgia,serif"; x.textAlign = "center"; x.textBaseline = "middle";
    x.shadowColor = "#39e7ff"; x.shadowBlur = 44; x.fillStyle = grad; x.fillText("GEM VAULT", S / 2, 150);
    x.shadowBlur = 0; x.lineWidth = 4; x.strokeStyle = "#5a3d0a"; x.strokeText("GEM VAULT", S / 2, 150);
