/* ============================================================
   fishshooter2.js — "FISH SHOOTER V2 · NEON ABYSS": a premium top-down fish-table (Ocean King
...
(function (root) {
  "use strict";
  var PIXI = root.PIXI, E = root.FishShooter2Engine; // OWN engine, decoupled from Reef Raiders (fishtable-engine.js)
  var DIR = "/assets/fishshooter2/";
  ...
  var FSH_COMMON = ["wisp", "ember", "prism", "lantern", "ray", "hatchet"];

  var clamp = function (v, a, b) { return Math.max(a, Math.min(b, v)); };
  var rand = function (a, b) { return a + Math.random() * (b - a); };
  var lerp = function (a, b, t) { return a + (b - a) * t; };

  function FishShooter2(opts) {
    opts = opts || {};
    this.els = opts.els || {};
  ...
  /* ---------- pixi + responsive ---------- */
  FishShooter2.prototype._initPixi = function () {
    var self = this;
    this._measure();
  ...
  FishShooter2.prototype._measure = function () {
  ...
  FishShooter2.prototype._resize = function () {
    if (!this.app) return;
  ...
  FishShooter2.prototype._coverBg = function (spr) {
  ...
  FishShooter2.prototype._layout = function () {
  ...
  FishShooter2.prototype._load = function () {
  ...
  FishShooter2.prototype._loadAssets = function (list, placeholderOnFail, done) {
    ...
    function tryLoad(item, attempt) {
      ...
      return PIXI.Assets.load(src + ASSET_Q).then(function (t) { self.tex[item.alias] = t; }, function (e) { // P5: ?v=fs1 → SW cache-first
        ...
        if (root.console) console.warn("[fishshooter2] asset failed after retries: " + item.alias, e && e.message);
  ...
  FishShooter2.prototype._placeholderTex = function () {
  ...
  FishShooter2.prototype._refreshBgSprites = function () {
  ...
  FishShooter2.prototype._bubbleTex = function () {
  ...
  FishShooter2.prototype._vignTex = function () {
  ...
  FishShooter2.prototype._fishDispW = function (def) {
  ...
  FishShooter2.prototype._sizeLabel = function (f) {
    if (!f.lbl) return;
  ...
  /* ---------- aim + fire ---------- */
  FishShooter2.prototype._pointAt = function (gx, gy) {
    if (this.lock) return;
  ...
  FishShooter2.prototype.cost = function () { return Math.round(this.unitBet * this.power * 100) / 100; };
  ...
  FishShooter2.prototype._tokenActive = function () { return !!(root.TokenMode && root.TokenMode.active()); };
  FishShooter2.prototype._fire = function (manual) {
  ...
  FishShooter2.prototype._clearRoundBullets = function () { for (var i = this.bullets.length - 1; i >= 0; i--) { var b = this.bullets[i]; if (b && (b.free || b.bossId)) this._rmBullet(b); } };
  ...
  FishShooter2.prototype._resolveHit = function (b, fish) {
    ...
    if (this._tokenActive() && !b.free) {
      ...
      root.TokenMode.bet("fishshooter2", b.cost, { targetKey: fish.def.key, power: b.power }).then(function (r) {
  ...
  FishShooter2.prototype._catch = function (fish, shot, isSplash) {
    ...
    if (!shot.free && !this._boss && !this._bonus && !this._bonusFinale && !isSplash && !this._tokenActive()) { // TOKEN: no self-funded jackpot meter (server RTP is flat; a server-side progressive is future v3)
      ...
      if (fish.def.key === "sovereign") bump = 0.30;
  ...
  FishShooter2.prototype._splashRoll = function (def, power, free, unitBet) {
  ...
  FishShooter2.prototype._bomb = function (src, shot) {
  ...
  FishShooter2.prototype._awardJackpot = function () {
  ...
  var WAVE_SPAWN = [
    { key: "wisp", w: 9 }, { key: "ember", w: 8 }, { key: "prism", w: 7 }, { key: "lantern", w: 6 },
    { key: "ray", w: 5 }, { key: "hatchet", w: 4 }, { key: "hammer", w: 2.4 }, { key: "voidkraken", w: 1.1 },
  ];
  var WAVE_TOTW = WAVE_SPAWN.reduce(function (a, x) { return a + x.w; }, 0);
  FishShooter2.prototype._pickWaveFish = function () {
    ...
    return E.BY_KEY.wisp;
  };
  FishShooter2.prototype._startFrenzy = function (dur, shot, kind) {
  ...
  FishShooter2.prototype._canBonus = function () { return this._frenzy <= 0 && !this._boss && !this._bonus && !this._bonusFinale; };
  ...
  FishShooter2.prototype._startTokenBonus = function (serverBonus, shot) {
    if (!this._canBonus()) return;
  ...
  FishShooter2.prototype._updateBonusFinale = function (dt) {
  ...
  FishShooter2.prototype._openChest = function (fish, shot) {
  ...
  FishShooter2.prototype._startBossRound = function () {
  ...
  FishShooter2.prototype._spawnBoss = function () {
  ...
  FishShooter2.prototype._accrueBoss = function (amount, x, y, isBossHit) {
  ...
  /* ---------- fx ---------- */
  FishShooter2.prototype._burst = function (x, y, scl) { // juicy additive coin-burst on a catch
  ...
  FishShooter2.prototype._screenFlash = function (color) {
  ...
  FishShooter2.prototype._net = function (x, y, color, big) {
  ...
  FishShooter2.prototype._autoAim = function () {
    var best = null, bs = -1;
  ...
  /* ---------- HUD ---------- */
  FishShooter2.prototype._usd = function (n) { return "$" + (Math.round((+n || 0) * 100) / 100).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 }); };
  FishShooter2.prototype._drawHud = function () {
  ...
  FishShooter2.prototype._renderHud = function () {
  ...
  FishShooter2.prototype._save = function () { if (this.onBalance) try { this.onBalance(this.balance); } catch (e) {} };

  /* ---------- input ---------- */
  FishShooter2.prototype._wireInput = function () {
    var self = this;
  ...
  FishShooter2.prototype.setEnabled = function (on) { this._enabled = !!on; this._renderHud(); };
  FishShooter2.prototype.setBalance = function (usd) { this.balance = Math.max(0, Math.round((+usd || 0) * 100) / 100); this._renderHud(); };
  FishShooter2.prototype.setEthUsd = function (n) { if (n > 0) this.ethUsd = n; };
  FishShooter2.prototype.setMode = function () {};
  FishShooter2.prototype.setBet = function (v) { this.unitBet = clamp(Math.round((+v || MIN_BET) * 100) / 100, MIN_BET, MAX_BET); this._renderHud(); };
  FishShooter2.prototype.setPower = function (p) { this.power = clamp(p | 0, 1, MAX_POWER); this._renderHud(); };
  FishShooter2.prototype.setFireSpeed = function (s) {
  ...
  FishShooter2.prototype.toggleAuto = function () { this.auto = !this.auto; this._holding = false; if (this.els.autoBtn) { this.els.autoBtn.classList.toggle("on", this.auto); this.els.autoBtn.setAttribute("aria-pressed", String(this.auto)); } };
  FishShooter2.prototype.toggleLock = function () { this.lock = !this.lock; if (this.els.lockBtn) { this.els.lockBtn.classList.toggle("on", this.lock); this.els.lockBtn.setAttribute("aria-pressed", String(this.lock)); } };
  FishShooter2.prototype.newSession = function () { this._sesSpent = 0; this._sesWon = 0; try { this._teardownRounds(); } catch (e) {} this._renderHud(); };
  FishShooter2.prototype.restartDemo = function () { this.auto = false; this.lock = false; this._holding = false; if (this.els.autoBtn) { this.els.autoBtn.classList.remove("on"); this.els.autoBtn.setAttribute("aria-pressed", "false"); } if (this.els.lockBtn) { this.els.lockBtn.classList.remove("on"); this.els.lockBtn.setAttribute("aria-pressed", "false"); } try { this._teardownRounds(); } catch (e) {} this._renderHud(); };
  ...
  FishShooter2.prototype._fsExit = function (t) {
  ...
  FishShooter2.prototype.toggleFullscreen = function (el) { var t = el || this._fsTarget || this.mount; if (!(t.classList && t.classList.contains("rr-fs"))) this.enterFullscreen(t, { auto: false }); else this._fsExit(t); };
  FishShooter2.prototype.exitFullscreen = function () { this._fsExit(this._fsTarget || this.mount); };
  FishShooter2.prototype.autoFullscreen = function (on, el) { var t = el || this._fsTarget || this.mount; if (on) { if (!this.isFullscreen()) this.enterFullscreen(t, { auto: true, skipNative: true }); } else if (this._fsAuto) this._fsExit(t); };

  root.FishShooter2 = FishShooter2;
