...
(function () {
  ...
  const SYM = [
    { key: "cherry",  glyph: "🍒", name: "Cherry",   weight: 22, pay: [0, 0, 0, 2, 5, 15] },
    { key: "bell",    glyph: "🔔", name: "Bell",     weight: 18, pay: [0, 0, 0, 3, 8, 20] },
    { key: "star",    glyph: "⭐", name: "Star",     weight: 16, pay: [0, 0, 0, 4, 12, 30] },
    { key: "cash",    glyph: "💵", name: "Cash",     weight: 13, pay: [0, 0, 0, 6, 18, 50] },
    { key: "eth",     glyph: "Ξ",  name: "Ethereum", weight: 10, pay: [0, 0, 0, 10, 30, 80],  glyphFill: 0xb9c7ff },
    { key: "btc",     glyph: "₿",  name: "Bitcoin",  weight: 7,  pay: [0, 0, 0, 15, 50, 150], glyphFill: 0xffd23f },
    { key: "seven",   glyph: "7",  name: "Lucky 7",  weight: 5,  pay: [0, 0, 0, 25, 100, 300], glyphFill: 0xff4d9d, seven: true },
    { key: "wild",    glyph: "💎", name: "WILD",     weight: 5,  pay: [0, 0, 0, 50, 200, 1000] },
    { key: "scatter", glyph: "🪙", name: "SCATTER",  weight: 4,  pay: [0, 0, 0, 2, 10, 50] }, // scatter pay × TOTAL bet
  ];
