...
(function (root) {
  ...
  PressureGame.prototype._eth = function (n) { return "Ξ" + (n / ETH_USD).toFixed(4); };
  ...
  PressureGame.prototype._wire = function () {
    ...
    window.addEventListener("keyup", (e) => { if (e.code === "Space") this._release(); });
